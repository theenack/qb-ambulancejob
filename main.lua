        ...
        while listen do
            if IsControlJustPressed(0, 38) then
                ...
                if variable == "checkin" then
                   TriggerEvent('qb-medicaljob:checkin')
                    listen = false
                elseif variable == "beds" then
                    TriggerEvent('qb-medicaljob:beds')
                    listen = false
                end
            end
            Wait(1)
...
RegisterNetEvent('qb-medicaljob:checkin', function()
        ...
        if not isDead and not InLaststand then
            exports['refine-radialbar']:Custom({
                ...
                Animation = {
                    ...
                    animDict = "missheistdockssetup1clipboard@base", -- https://alexguirre.github.io/animations-list/
                    anim = "base",
                },
                PropAttach = {
...
RegisterNetEvent('qb-medicaljob:beds', function()
